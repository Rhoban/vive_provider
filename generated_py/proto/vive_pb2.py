...
_TRACKERMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pose_matrix', full_name='vive_provider.TrackerMsg.pose_matrix', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='device_type', full_name='vive_provider.TrackerMsg.device_type', index=7,
...
_TRACKERMSG.fields_by_name['pose_matrix'].message_type = _MATRIX4X3
